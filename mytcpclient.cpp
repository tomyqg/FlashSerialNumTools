...
void MyTCPClient::connectTo(QHostAddress addr, quint16 port)
{
    ...
    connect(tcpSocket, SIGNAL(error(QAbstractSocket::SocketError)), this, SLOT(onConnectErr(QAbstractSocket::SocketError)));
}
...
void MyTCPClient::onConnectErr(QAbstractSocket::SocketError err)
{
    qDebug() << "in err:" << err;
